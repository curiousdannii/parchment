 ...
 */
$.ajaxSetup({cache:true,dataType:"text",ifModified:location.protocol!=="file:"});var parchment={};(function(f){var i=/\(['"](.+)['"]\)/,a=function(p,q){var q=q||[],o=0,n;for(n=p.length%8;o<n;++o){q.push(p.charCodeAt(o)&255)}for(n=p.length;o<n;){q.push(p.charCodeAt(o++)&255,p.charCodeAt(o++)&255,p.charCodeAt(o++)&255,p.charCodeAt(o++)&255,p.charCodeAt(o++)&255,p.charCodeAt(o++)&255,p.charCodeAt(o++)&255,p.charCodeAt(o++)&255)}return q},l=function(r,q){var q=q||"",p=0,n,o=String.fromCharCode;for(n=r.length%8;p<n;++p){q+=o(r[p])}for(n=r.length;p<n;){q+=(o(r[p++])+o(r[p++])+o(r[p++])+o(r[p++])+o(r[p++])+o(r[p++])+o(r[p++])+o(r[p++]))}return q};if(f.atob){var c=function(o,n){return a(atob(o),n)},h=function(o,n){return btoa(l(o,n))}}else{var g="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",b=(function(){var n=[],o=0;for(;o<g.length;o++){n[g.charAt(o)]=o}return n})(),c=function(s,q){var q=q||[],t,p,o,x,w,v,u,r=0,n=s.length;while(r<n){x=b[s.charAt(r++)];w=b[s.charAt(r++)];v=b[s.charAt(r++)];u=b[s.charAt(r++)];t=(x<<2)+(w>>4);p=((w&15)<<4)+(v>>2);o=((v&3)<<6)+u;q.push(t,p,o)}if(u==64){q.pop()}if(v==64){q.pop()}return q},h=function(s,q){var q=q||"",t,p,o,x,w,v,u,r=0,n=s.length;while(r<n){t=s[r++];p=s[r++];o=s[r++];x=t>>2;w=((t&3)<<4)+(p>>4);v=((p&15)<<2)+(o>>6);u=o&63;q+=(g.charAt(x)+g.charAt(w)+g.charAt(v)+g.charAt(u))}if(isNaN(p)){q=q.slice(0,-2)+"=="}else{if(isNaN(o)){q=q.slice(0,-1)+"="}}return q}}var m=jQuery.ajaxSettings.xhr(),k={binary:m.overrideMimeType!==undefined,cross_origin:m.withCredentials!==undefined},d=function(o,q){var p=function(r){q(c(i.exec(r)[1]))},n=function(r){q(a(r))};if(o.slice(-3).toLowerCase()===".js"){$.ajax({error:j,success:p,url:o})}else{$.ajax({beforeSend:e,error:j,success:n,url:o})}},e=function(n){n.overrideMimeType("text/plain; charset=x-user-defined")},j=function(n,o){throw new FatalError("Error loading story: "+o)};m=null;f.file={text_to_array:a,array_to_text:l,base64_decode:c,base64_encode:h,download_to_array:d,support:k}})(window);(function(){window.gIsIphone=navigator.userAgent.match(/iPhone/i);var b;var a="0";$(document).ready(function(){b=document.getElementById("top-window");a="0";var d=navigator.appVersion.match(/MSIE (\d+)\./);if(d&&+d[1]<7){b.style.position="absolute";var c=function(){b.style.top=1*(document.documentElement.scrollTop+1*a)+"px"};window.onscroll=c;window.onresize=c}})})();(function(e){var g=IFF.extend({init:function a(o,j){this.title=j;if(o[0]<9){this.filetype="ok story naked zcode";this._super();this.chunks.push({type:"ZCOD",data:o});this.zcode=o}else{if(IFF.text_from(o,0)=="FORM"){this._super(o);if(this.type=="IFRS"){for(var m=0,h=this.chunks.length;m<h;m++){var n=this.chunks[m].type;if(n=="ZCOD"&&!this.zcode){this.zcode=this.chunks[m].data}else{if(n=="IFmd"){this.metadata=file.array_to_text(this.chunks[m].data);var k=$(this.metadata);if(k){if($("title",k)){this.title=$("title",k).text()}if($("ifid",k)){this.ifid=$("ifid",k).text()}if($("release",k)){this.release=$("release",k).text()}}}}}if(this.zcode){this.filetype="ok story blorbed zcode"}else{this.filetype="error: no zcode in blorb"}}else{if(this.type=="IFZS"){this.filetype="error: trying to load a Quetzal savefile"}else{this.filetype="error unknown iff"}}}else{this.filetype="error unknown general"}}},load:function b(h){if(this.zcode){h.loadStory(this.zcode)}}}),d=Class.extend({add:function(h){this[h.ifid]=h;if(h.url){this.url[h.url]=h}},url:{}}),c=function(i,h){var j,k=function(r){if($.isArray(r)){j=r}if(h.loaded_zmachine||e.GnustoEngine&&e.Quetzal&&e.EngineRunner&&e.Console&&e.WebZui&&j){h.loaded_zmachine=true;$("#progress-text").html("Starting interpreter...");var q=typeof console!==undefined?function(){}:function(s){e.console.log(s)},n=new GnustoEngine(q),l=new WebZui(n,q),p=new EngineRunner(n,l,q),o=new g(j.slice(),storyName);q("Story type: "+o.filetype);o.load(n);if(e.location.hash){var m=e.location.hash.slice(1);n.loadSavedGame(file.base64_decode(m));q("Loading savefile")}p.run()}};if(!h.loaded_zmachine){$.getScript("lib/gnusto.min.js",k);$.getScript("lib/zmachine.min.js",k)}file.download_to_array(i,k)},f=Class.extend({load:function(k){var h=new Querystring(),i=h.get("story",parchment.options.default_story);storyName=i.slice(i.lastIndexOf("/")+1);storyName=storyName?storyName+" - Parchment":"Parchment";e.document.title=storyName;if(this.stories.url[i]){var j=this.stories.url[i]}else{$("#progress-text").html("Retrieving story file...");c(i,this)}},stories:new d(),savefiles:{}});e.Library=f})(window);(function(a){var c=a.parchment;c.options={default_story:"stories/troll.z5.js",zcode_appspot_url:"http://zcode.appspot.com/"};function b(){if(a.parchment_options){$.extend(c.options,parchment_options)}var d=new Library();c.library=d;d.load();if(location.href.slice(0,31)=="http://parchment.googlecode.com"){$.getScript("http://www.google-analytics.com/ga.js",function(){gat._getTracker("UA-7949545-1")._trackPageview()})}}$(b)})(window);
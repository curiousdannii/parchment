...
/* inc */ 133: Incdec,
/* dec */ 134: Incdec,
/* print_addr */ 135: opcode_builder( Opcode, function( addr ) { return 'e.print_addr(' + addr + ')'; } ),
...
/* print_paddr */ 141: opcode_builder( Opcode, function( addr ) { return 'e.print_addr(' + addr + '*' + this.e.addr_multipler + ')'; } ),
